                                                    ...
                                                    return (
                                                        (lesson.type === "LESSON") ? (
                                                            <tr key={index}>
                                                                ...
                                                                <td>
                                                                    {(props.Check) ?
                                                                        <button type="button" className="btn btn-danger" onClick={() => handleShow(lesson._id, "delete")} >
                                                                        ...
                                                                        :
                                                                        <button type="button" className="btn btn-success" onClick={() => handleShow(lesson._id, "add")} >
                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                width="16"
                                                                                height="16"
                                                                                fill="currentColor"
